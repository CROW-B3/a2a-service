/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7610f8999117adb38294ade3d8627303)
// Runtime types generated with workerd@1.20260111.0 2026-01-14 nodejs_als,nodejs_compat
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    BASE_URL:
      | 'https://a2a.crowai.dev'
      | 'https://dev.a2a.crowai.dev'
      | 'http://localhost:8020';
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      'ENVIRONMENT' | 'BASE_URL' | 'AI_GATEWAY_ID' | 'BFF_CHAT_URL'
    >
  > {}
}
